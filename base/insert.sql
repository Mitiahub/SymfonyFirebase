...
(2, 1, 2),  -- Commande 2 contient 2x Pizza
(2, 2, 1),  -- Commande 2 contient 1x Soupe
(3, 3, 3);  -- Commande 3 contient 3x Sandwich

INSERT INTO commande_ingredient (commande_id, ingredient_id) VALUES
-- Commande 2 (contient Pizza et Soupe)
(2, 1),  -- Tomate (pour Pizza)
(2, 2),  -- Pâte (pour Pizza)
(2, 3),  -- Oignon (pour Soupe)
(2, 4),  -- Bouillon de soupe (pour Soupe)

-- Commande 3 (contient Sandwich)
(3, 5),  -- Fromage (pour Sandwich)
(3, 6),  -- Pain (pour Sandwich)
(3, 7);  -- Charcuterie (pour Sandwich)
